...
class Events extends Component {
  ...
  getActiveEventDetails = () => {
    ...
    return eventsList.find(eachEvent => eachEvent.id === activeEventId)
  }
  ...
  renderActiveEventRegistrationDetails = () => {
    ...
    const activeEvent = this.getActiveEventDetails()

    return (
      <ActiveEventRegistrationDetails
        registrationStatus={activeEvent.registrationStatus}
      />
    )
  }
